...
@section('content')
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-center">
                        <h1><font color = "yellow">Hospital</font></h1>
                        <h3><font color = "yellow">Where the miracle happens</font></h3>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption text-center">
                        <h1>Doctor</h1>
                        <h3>Doctors are highly specialized for everyone's need</h3>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption text-center">
                        <h1>Register</h1>
                        <h3>We will go through how to register step by step</h3>
    ...
    <div class="container text-center my-4 mb-5">
        <h1><strong>Check our hospitals for more information!</strong></h1>
    </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Welcome to UCSD Health</p>
